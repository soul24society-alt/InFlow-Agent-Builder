...
const toolIcons: Record<string, React.ReactNode> = {
  ...
  deploy_token: <Coins className="h-4 w-4" />,
  deploy_nft_collection: <ImageIcon className="h-4 w-4" />,
  ...
  wrap_oct: <Repeat className="h-4 w-4" />,
  ...
  condition_check: <ToggleLeft className="h-4 w-4" />,
  yes_no_answer: <ThumbsUp className="h-4 w-4" />,
...
const toolColors: Record<string, { border: string; bg: string; text: string }> = {
  ...
  deploy_token: { border: "border-foreground/40", bg: "bg-foreground/5", text: "text-foreground" },
  deploy_nft_collection: { border: "border-foreground/50", bg: "bg-foreground/10", text: "text-foreground" },
  ...
  wrap_oct: { border: "border-foreground/40", bg: "bg-foreground/5", text: "text-foreground" },
  ...
  condition_check: { border: "border-foreground/50", bg: "bg-foreground/10", text: "text-foreground" },
  yes_no_answer: { border: "border-foreground/60", bg: "bg-foreground/15", text: "text-foreground" },
  send_webhook: { border: "border-foreground/40", bg: "bg-foreground/5", text: "text-foreground" },
